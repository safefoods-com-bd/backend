...
/**
 * Controller function to retrieve media data with pagination and HATEOAS links.
 *
...
export const listAllMediaV100 = async (req: Request, res: Response) => {
  try {
    ...
    const totalCountQuery = db.select({ count: count() }).from(mediaTable);

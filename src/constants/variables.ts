...
export const EMAIL_VERIFICATION_TOKEN_NAME =
  process.env.EMAIL_VERIFICATION_TOKEN_NAME || "email_verification_token";
export const OTP_VERIFICATION_TOKEN_NAME =
  process.env.OTP_VERIFICATION_TOKEN_NAME || "otp_verification_token";
